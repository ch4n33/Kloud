# Kloud Project Context for Agents

This file preserves project-specific repository context that was previously stored in `CLAUDE.md`. The root `CLAUDE.md` now tracks the Karpathy-style coding-principles document.
